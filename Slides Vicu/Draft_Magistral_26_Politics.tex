...
\node[] at(6,-2) {\underline{Mercado de Bienes}};
...
\draw[fill](4,3) circle [radius =0.12];
\end{tikzpicture}
\end{center}
     \end{minipage}
  %  \hfill
...
\node[] at(6,-2) {\underline{Mercado de Dinero}};
...
\node[below] at(3.5,0) { \footnotesize $M_0$};
 \draw[thick, gray, dashed] (3.5,3.35)--(0,3.35) node[left, black]{ \footnotesize $i_0$};
\draw[fill](3.5,3.35) circle [radius =0.12];
\end{tikzpicture}
\end{center}
    \end{minipage}
\end{center}
...
\draw[semithick](0, 5)--(9,7) node [right]{\footnotesize $OA$};
 \draw[thick, gray, dashed] (2,0) node [below, black]{\footnotesize $Y_0$} --(2,5.5) ;
\draw[fill](2,5.4) circle [radius =0.12];
\draw[thick, gray, dashed] (0,5.4) node [left, black]{\footnotesize $P_0$} --(2,5.4) ;
\end{tikzpicture}
\end{center}
     \end{minipage}
  %  \hfill
...
\draw[semithick](3.5, 0)--(3.5, 9) node [above]{\footnotesize $M^{o}$};
\node[below] at(3.5, 0) { \footnotesize $M_0(P_0,Y_0)$};
 \draw[thick, gray, dashed] (3.5,3.35)--(0,3.35) node[left, black]{ \footnotesize $i_0$};
\draw[fill](3.5,3.35) circle [radius =0.12];
\end{tikzpicture}
\end{center}
...
\begin{frame}{Política Monetaria en el mundo clásico}
    ...
    \only<3->{
        ...
        \node[left, green!50!black] at (0,5) {$P_1$};
        \draw[fill, green!50!black] (4,5) circle [radius =0.11] node[above right] {$C$};
    }
    \end{tikzpicture}
    \end{center}
    \end{minipage}
    ...
    \only<3->{
        ...
        \draw[fill, green!50!black] (6.5,3.35) circle [radius =0.11] node[above right] {$C$};
    }
    \end{tikzpicture}
    \end{center}
    \end{minipage}
    ...
    \begin{itemize}
        ...
        \only<3->{
        \item \textcolor{green!50!black}{Eso presiona hacia arriba los precios e incrementa la demanda de dinero (lo que reduce la oferta de FP en el mercado de crédito).}}
    \end{itemize}
\end{frame}
...
\begin{frame}{Política monetaria en el mundo keynesiano}
    ...
    \draw[semithick](0, 5)--(9, 7) node [right]{\footnotesize $OA$};
    \draw[fill] (2,5.5) circle [radius =0.11] node[below left] {\footnotesize $A$};
    \only<2->{
        ...
        \node[above left, blue] at (0,5.65) {\footnotesize $P_1$};
        \draw[fill, blue] (2.8,5.65) circle [radius =0.11] node[above right] {\footnotesize $B$};
    }
    \only<3->{
        \draw[semithick, gray, fill] (2,0)--(2,9) node [right]{\footnotesize $OALP$};
        \draw[fill] (2,7.65) circle [radius =0.11] node[right] {\footnotesize $C$};
    }
    \end{tikzpicture}
    \end{center}
    \end{minipage}
    ...
    \node[right] at (0,11) {};
    \node[] at(6,-1.5) {\underline{Mercado de Dinero}};
    \draw[semithick] (1,9).. controls (2,3) and (4, 2.5) .. (9, 1.5) node [right]{\scriptsize $M^{d}(P_0,\, Y_0)$};
    ...
    \draw[fill] (3.4,3.35) circle [radius =0.11] node[above right] {\footnotesize $A$};
    \only<2->{
        \draw[semithick, blue] (1.75,9).. controls (2.25,3) and (6.75, 2.5) .. (9, 2.15) node [right]{\scriptsize $M^{d^{'}}(P_1,\, Y_1)$};
        \draw[semithick, gray, dashed] (3.5,3.35)--(0,3.35);
        \draw[semithick, blue, dashed] (6.5,2.625)--(0,2.625);
        \node[left, blue] at (0,2.625) {\footnotesize $i_1$};
        \draw[fill, blue] (6.5,2.625) circle [radius =0.11] node[right] {\footnotesize $B$}; 
    }
    \only<3->{
        \draw[semithick, gray, dashed] (2.5,9).. controls (2.25,3.7) and (6.75, 3.5) .. (9, 2.9) node [right]{\scriptsize $M^{d^{''}}(P_2,\, Y_0)$};
        \draw[fill] (6.5,3.35) circle [radius =0.11] node[above right] {\footnotesize $C$};
    }
    \end{tikzpicture}
    \end{center}
    \end{minipage}
...
\end{center} 
    \begin{itemize}
        \footnotesize
        \item Aumenta la $DA$: $DA'=$ \textcolor{blue}{ $\downarrow C$} $+ I+$ \textcolor{blue}{$\uparrow \uparrow G $}
        \only<2->{
            \item El producto fijo genera un exceso de demanda (punto B) que obliga a una \textcolor{green!50!black}{suba de precios $\rightarrow$ la demanda de dinero aumenta y también la tasa de interés} 
        }
        \only<3->{ \item En el punto C el crowding out fue total:  $\uparrow i$ induce a que el gasto privado caiga en exactamente la misma magnitud en la que aumentó el gasto público}
    \end{itemize}
\end{frame}
...
\only<3->{
    \draw[thick, red!30] (2.1,0)--(2.1,9) node [right]{\scriptsize $OALP$};
...
\end{center} 
    ...
    \begin{itemize}
        \footnotesize
        \item \textcolor{blue}{Aumenta la $DA$ ($DA'= \downarrow C + I + \uparrow \uparrow G $) y la demanda de dinero sube}
        \only<2->{
            \item Al estar encima del pleno empleo, \textcolor{green!50!black}{los precios empiezan a subir y el efecto expansivo se reduce hasta C, aumentando a la vez la demanda de dinero} 
        }
