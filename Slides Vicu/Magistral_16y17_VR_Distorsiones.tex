...
%\path[pattern=horizontal lines,pattern color=red] (4.5,3.6)--(4.5,5.5)--(5.4,4.5);
%\draw[semithick,dashed,gray](0,5.5)--(4.5,5.5)--(4.5,0);
%\draw[semithick,dashed, gray](0,3.6)--(4.5,3.6);
%\node [right, red] at (7,5) {\scriptsize Triángulo de};
%\node [right, red] at (7.25,4.5) {\scriptsize Harberger};
%\draw[semithick, red, <-] (5.3,4.2)..controls (5.8,3.8) and (6.8,3.8)..(7.5,4.2);
...
\begin{frame}
\frametitle{Incidencia de un impuesto a los vendedores}
\begin{figure} [H]
\centering
\begin{tikzpicture}[scale=0.6]
...
\begin{itemize}
    \item Si se impone un impuesto $t$ sobre las cantidades \textbf{consumidas}, la curva de la demanda se desplaza hacia abajo en una cantidad igual al monto del impuesto.
...
\begin{frame}
\frametitle{Incidencia de un impuesto a los consumidores}
\begin{figure} [H]
\centering
\begin{tikzpicture}[scale=0.6]
\draw[fill,red!20] (2.25,6.25) rectangle (0,5);
...
\begin{frame}
\frametitle{Comparando impuesto a los vendedores y consumidores}

\begin{columns}
\begin{column}{0.47\textwidth}
\centering
\caption{\small Impuesto a vendedores}
...
\centering
\caption{\small Impuesto a consumidores}
\begin{tikzpicture}[scale=0.48]
\draw[fill,red!20] (2.25,6.25) rectangle (0,5);
\draw[fill,blue!20] (0,3.75) rectangle (2.25,5);
\draw[fill,black!20] (3.5,5)--(2.25,3.75)--(2.25,6.25);
...
\begin{columns}
    ...
    \centering
    \hfill
    \includegraphics[scale=0.145]{Slides Principios de Economia/Figures/Magistral_17/M17.1.jpg}    
    \end{column}
    \begin{column}{0.49\textwidth}
    \centering
    \includegraphics[scale=0.24]{Slides Principios de Economia/Figures/Magistral_17/M17.2.png}    
    \hfill
    \end{column}
\end{columns}
...
\begin{frame}{Poniéndole precio a una carretera}
\begin{figure} [H]
\centering
\begin{tikzpicture}[scale=0.6]
\draw[very thick,<->] (0,10) node[above]{$P$}--(0,0)--(10,0) node[right]{$Q$};
