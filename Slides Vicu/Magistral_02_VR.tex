...
%\\ Capítulo 6: Restricción Presupuestaria}
%\date{}
...
\begin{frame}
\frametitle{¿Cómo construimos la restricción presupuestaria?} 
\begin{center}
\begin{tikzpicture}
    % Ejes
...
\begin{frame}
\frametitle{Canastas factibles vs canastas inalcanzables} 
\begin{center}
\begin{tikzpicture}
    % Ejes
    \draw[thick,->] (0,0) -- (6,0) node[below] {Pizza};
...
\begin{itemize}
    \item A la pendiente de la restricción presupuestaria la llamaremos \textbf{Tasa Marginal de Transformación (TMT)}
   \vspace{2mm}
...
\begin{frame}
\frametitle{Límite de consumo de harina}
...
\begin{tikzpicture}
    ...
    \node at (7,3.9) {\includegraphics[width=3.5cm]{Slides Principios de Economia/Figures/limite-compra-aceite-harina-3-1024x768.jpg}};
\end{tikzpicture}
\end{center}
\end{frame}
