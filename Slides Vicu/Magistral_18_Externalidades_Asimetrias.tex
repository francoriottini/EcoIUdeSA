...
\begin{frame}{Desparasitación, Educación y Salud: Un Ciclo Virtuoso}
    ...
    \begin{column}{0.5\textwidth}
        \includegraphics[width=\linewidth]{Slides Principios de Economia/Figures/Magistral_18/M18.8.jpg}
...
\begin{frame}{Externalidades}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}    
            ...
            \node at (9,3.7) {\tiny ¿Utilidad marginal};
            \node at (9,3.2) {\tiny social o privada?};
        ...
        \begin{column}{0.5\textwidth}
            \begin{itemize}
            \item Las curvas siempre fueron \textbf{sociales}, aunque las veíamos como privadas.
                \item Si las curvas \textit{sociales} son diferentes a las \textit{privadas}, entonces hay una externalidad.
                \item ¿Qué pasa con las cantidades de equilibrio?
                \item ¿Cómo afecta esto a productores y consumidores?
...
\begin{frame}{Riesgo Moral}
    ...
    \end{itemize}
    \centering
    \includegraphics[scale=0.08]{Slides Principios de Economia/Figures/Magistral_18/M18.10.jpeg} \hspace{5mm}
    \includegraphics[scale=0.1]{Slides Principios de Economia/Figures/Magistral_18/M18.11jpg.jpg}
\end{frame}
