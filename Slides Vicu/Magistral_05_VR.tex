...
\begin{frame}
    \frametitle{Producto marginal y medio}
    \centering
    \includegraphics[scale=0.27]{Slides Principios de Economia/Figures/Magistral_05/C12.7.jpg}
\end{frame}
...
\begin{frame}
\frametitle{La estructura de costos de corto plazo de la empresa}
