...
%\begin{frame}
%\frametitle{La curva de oferta}
%\includegraphics[scale=0.6]{Slides Principios de Economia/Figures/Tema_07.2_curvadeofertanew.jpg}
%\end{frame} 

%%%%%%%%%% SEPARAR CAPITULO 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\title[Principios de Economía]{Principios de Economía %\vspace{4mm}
%\\ Capítulo 15: El equilibrio de la oferta y la demanda}
%\date{}
%\vspace{0.4cm}
%\institute[]{Introduzca su nombre aquí} 
...
\centering
\includegraphics[scale=0.6]{Slides Principios de Economia/Figures/}
% Grafico 15.7
\end{frame}
...
%%%%%%%%%SEPARAR CAPITULO%%%%%%%
%\title[Principios de Economía]{Principios de Economía %\vspace{4mm}
%\\ Capítulo 17: El rol del mercado en la asigncación de recursos}
%\date{}
