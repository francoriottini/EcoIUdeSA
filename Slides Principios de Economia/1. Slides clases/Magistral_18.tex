...
%    \begin{figure} [H]   \includegraphics[scale=0.5]{Slides Principios de Economia/Figures/C17.2.png}
%\end{figure}
%\end{frame}
...
%\frametitle{HDI (2017)}
%\begin{center}
%    \href{https://ourworldindata.org/grapher/human-development-index?country=~ZWE} {\includegraphics[scale=0.35]{Slides Principios de Economia/Figures/Tema_11.27_hdi_PBI.png}}
%\end{center}
%Fuente: Our World in Data
%\end{frame}
...
\frametitle{Un ejemplo aplicado}
    \begin{center}    
    \includegraphics[scale=0.55]{Slides Principios de Economia/Tema_04.16_lorenz1.jpg}
    \end{center}
\end{frame}
