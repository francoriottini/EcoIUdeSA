...
\centering
\includegraphics[scale=0.5]{Slides Principios de Economia/Figures/Preciominimo.png}
\end{frame}
...
\begin{frame}{Poniéndole precio a una carretera  I}
     \begin{figure} [h!]
    \centering
    \includegraphics[width=0.80\textwidth]{Slides Principios de Economia/Figures/Paseobajo.jpg}
