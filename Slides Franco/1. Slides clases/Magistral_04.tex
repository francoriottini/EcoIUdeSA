...
\begin{frame}{Gráficamente..}
    Supongamos que el salario por hora es igual a \$10
        \begin{center}
        \begin{figure}[H]
        \renewcommand{\figurename}{Figure}
        \begin{center}
...
\begin{frame}{La TMT en el modelo ocio - consumo}
        \begin{center}
    \begin{figure}[H]
    \renewcommand{\figurename}{Figure}
    \begin{center}
    ...
    \draw[fill] (0,6.5) circle [radius =0.12] node [left] {\footnotesize \$240};
    \draw [thin, decorate,decoration={brace,amplitude=4pt, mirror},xshift=0pt,yshift=5pt] (-1.5,2.8) -- (-1.5,2);
...
\begin{frame}{El equilibrio}
    ...
    \draw[thin] (1.75,9).. controls (2.15,4.35) and (7, 3) .. (9, 2.75) node [right]{\footnotesize $U_2$};
...
\begin{frame}{¿Por qué G no es un equilibrio?}
    \begin{center}
    \begin{figure}[H]
    \renewcommand{\figurename}{Figure}
    \begin{center}
...
\begin{frame}{¿Por qué B no es un equilibrio?}
    \begin{center}
    \begin{figure}[H]
    \renewcommand{\figurename}{Figure}
    \begin{center}
    ...
    \draw[very thick,<->] (0,11) node[left]{Consumo}--(0,0)--(11,0) node[below]{Horas de ocio};
    \draw[thin, gray] (0.75,9).. controls (2,3) and (6, 2) .. (9, 1.75) node [right]{\footnotesize $U_1$} ;
    \draw[thin, gray] (1.25,9).. controls (2.07,3.75) and (6.5, 2.5) .. (9, 2.25) node [right]{\footnotesize $U_11$} ;
    \draw[thin] (1.75,9).. controls (2.15,4.35) and (7, 3) .. (9, 2.75) node [right]{\footnotesize $U_2$};
     \draw[thin] (0,8)--(9.75,0) ;
     \draw[thick,gray,dashed] (3.9,0)--(3.9,4.9)--(0,4.85);
    \draw[thick,gray,dashed] (1.4,0)--(1.4,6.9)--(0,6.9);
