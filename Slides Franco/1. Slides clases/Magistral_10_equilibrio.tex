...
\begin{frame}{Ejemplo 2. Aumenta el costo de producir el bien}
        \begin{figure}[H]
        \begin{center}
            \begin{tikzpicture}[scale=0.8]
            \draw[thick,->] (0,0) -- (7.5,0) node[below] {$Q$};
...
\begin{frame}{Ejemplo 3: Caída en los ingresos y avance tecnológico}
        \begin{figure}[H]
        \begin{center}
...
\begin{frame}{Ejemplo 4: Caída en precio de un bien sustituto y shock climático negativo}
    \begin{figure}[H]
    \begin{center}
        \begin{tikzpicture}[scale=0.9]
        \draw[thick,->] (0,0) -- (7.5,0) node[below] {$Q$};
        ...
        % Cambios de oferta
        \draw [thick, blue] (0,2.15) -- (5,7.15);
        \node [right, blue] at (5,7.15) {$O_2$};
        ...
        % Nuevo equilibrio
        \draw[dashed, gray] (0.8,0) -- (0.8,2.98);
        \draw[dashed, gray] (0,2.98) -- (0.8,2.98);
        \fill[blue] (0.8,2.96) circle (2.1pt);
        \node [above, blue] at (0.9,3.05) {\footnotesize $E_2$};
        \node[below, blue] at (0.8,0) {\small $Q_{2}^{*}$};
        \node[left, blue] at (0,2.98) {\small $P_{2}^{*}$};
