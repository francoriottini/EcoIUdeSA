...
\pause
\begin{itemize}
    \item ¿Es eficiente esta asignación? \pause
    \item ¿Qué pasaría si el mecanismo de asignación fuera un planificador central? ¿A gran escala se puede? \pause
...
\begin{itemize}
    ...
    \item Construimos una descripción simplificada en base a \textbf{la pregunta de interés} \pause 
...
\begin{frame}{¿Qué es un buen modelo?}
    \begin{itemize}
        \item El que nos ayuda a entender algo importante
        \item Predice con precisión: sus predicciones son consistentes con la evidencia
...
\begin{frame}{¿Por qué vamos a usar gráficos?}
    \begin{itemize}
